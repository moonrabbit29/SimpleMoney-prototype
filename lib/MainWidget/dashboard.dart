...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget build(BuildContext context) {
    var data = [
      ClickPerMonth('Jan', 30, Colors.orange),
      ClickPerMonth('Feb', 42, Colors.yellow),
      ClickPerMonth('Mar', 54, Colors.orange),
      ClickPerMonth('Apr', 20, Colors.yellow),
      ClickPerMonth('May', 76, Colors.orange),
      ClickPerMonth('Jun', 35, Colors.yellow),
    ];
